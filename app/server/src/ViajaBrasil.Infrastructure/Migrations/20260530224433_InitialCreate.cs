        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CityIbgeCode = table.Column<string>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TouristSpots_Cities_CityIbgeCode",
                        column: x => x.CityIbgeCode,
                        principalTable: "Cities",
                        principalColumn: "IbgeCode",
                        onDelete: ReferentialAction.Restrict);
                });

            migrationBuilder.InsertData(
                table: "Cities",
                columns: new[] { "IbgeCode", "Name", "State" },
                values: new object[,]
                {
                    ...
                    { "1303700", "SANTO ANTONIO DO IÇA", "AM" },
                    { "1303809", "SAO GABRIEL DA CACHOEIRA", "AM" },
                    { "1303908", "SAO PAULO DE OLIVENÇA", "AM" },
                    ...
                    { "1502202", "CAPANEMA", "PA" },
                    { "1502301", "CAPITAO POÇO", "PA" },
                    { "1502400", "CASTANHAL", "PA" },
                    { "1502509", "CHAVES", "PA" },
                    { "1502608", "COLARES", "PA" },
                    { "1502707", "CONCEIÇAO DO ARAGUAIA", "PA" },
                    ...
                    { "1504901", "MUANA", "PA" },
                    { "1504950", "NOVA ESPERANÇA DO PIRIA", "PA" },
                    ...
                    { "1705607", "CONCEIÇAO DO TOCANTINS", "TO" },
                    ...
                    { "2103505", "COLINAS", "MA" },
                    { "2103554", "CONCEIÇAO DO LAGO-AÇU", "MA" },
                    { "2103604", "COROATA", "MA" },
                    { "2103703", "CURURUPU", "MA" },
                    ...
                    { "2202802", "CONCEIÇAO DO CANINDE", "PI" },
                    ...
                    { "2208700", "REDENÇAO DO GURGUEIA", "PI" },
                    { "2208809", "REGENERAÇAO", "PI" },
                    ...
                    { "2209757", "SAO GONÇALO DO GURGUEIA", "PI" },
                    { "2209807", "SAO GONÇALO DO PIAUI", "PI" },
                    ...
                    { "2210359", "SAO LOURENÇO DO PIAUI", "PI" },
                    ...
                    { "2312403", "SAO GONÇALO DO AMARANTE", "CE" },
                    ...
                    { "2412005", "SAO GONÇALO DO AMARANTE", "RN" },
                    ...
                    { "2512077", "POÇO DE JOSE DE MOURA", "PB" },
                    { "2512101", "POMBAL", "PB" },
                    { "2512200", "PRATA", "PB" },
                    ...
                    { "2515104", "SAO SEBASTIAO DE LAGOA DE ROÇA", "PB" },
                    ...
                    { "2601607", "BELEM DO SAO FRANCISCO", "PE" },
                    ...
                    { "2908002", "COARACI", "BA" },
                    { "2908101", "COCOS", "BA" },
                    { "2908200", "CONCEIÇAO DA FEIRA", "BA" },
                    { "2908309", "CONCEIÇAO DO ALMEIDA", "BA" },
                    { "2908408", "CONCEIÇAO DO COITE", "BA" },
                    { "2908507", "CONCEIÇAO DO JACUIPE", "BA" },
                    { "2908606", "CONDE", "BA" },
                    { "2908705", "CONDEUBA", "BA" },
                    { "2908804", "CONTENDAS DO SINCORA", "BA" },
                    { "2908903", "CORAÇAO DE MARIA", "BA" },
                    ...
                    { "2929305", "SAO GONÇALO DOS CAMPOS", "BA" },
                    ...
                    { "2932903", "VALENÇA", "BA" },
                    { "2933000", "VALENTE", "BA" },
                    { "2933059", "VARZEA DA ROÇA", "BA" },
                    { "2933109", "VARZEA DO POÇO", "BA" },
                    ...
                    { "3115102", "CASSIA", "MG" },
                    { "3115201", "CONCEIÇAO DA BARRA DE MINAS", "MG" },
                    ...
                    { "3116407", "CLARAVAL", "MG" },
                    { "3116506", "CLARO DOS POÇOES", "MG" },
                    { "3116605", "CLAUDIO", "MG" },
                    { "3116704", "COIMBRA", "MG" },
                    { "3116803", "COLUNA", "MG" },
                    { "3116902", "COMENDADOR GOMES", "MG" },
                    { "3117009", "COMERCINHO", "MG" },
                    { "3117108", "CONCEIÇAO DA APARECIDA", "MG" },
                    { "3117207", "CONCEIÇAO DAS PEDRAS", "MG" },
                    { "3117306", "CONCEIÇAO DAS ALAGOAS", "MG" },
                    { "3117405", "CONCEIÇAO DE IPANEMA", "MG" },
                    { "3117504", "CONCEIÇAO DO MATO DENTRO", "MG" },
                    { "3117603", "CONCEIÇAO DO PARA", "MG" },
                    { "3117702", "CONCEIÇAO DO RIO VERDE", "MG" },
                    { "3117801", "CONCEIÇAO DOS OUROS", "MG" },
                    ...
                    { "3118502", "CONSOLAÇAO", "MG" },
                    { "3118601", "CONTAGEM", "MG" },
                    { "3118700", "COQUEIRAL", "MG" },
                    { "3118809", "CORAÇAO DE JESUS", "MG" },
                    ...
                    { "3125507", "SAO GONÇALO DO RIO PRETO", "MG" },
                    ...
                    { "3136504", "JORDANIA", "MG" },
                    { "3136520", "JOSE GONÇALVES DE MINAS", "MG" },
                    ...
                    { "3158201", "SANTA MARIA DO SUAÇUI", "MG" },
                    ...
                    { "3161700", "SAO GONÇALO DO ABAETE", "MG" },
                    { "3161809", "SAO GONÇALO DO PARA", "MG" },
                    { "3161908", "SAO GONÇALO DO RIO ABAIXO", "MG" },
                    { "3162005", "SAO GONÇALO DO SAPUCAI", "MG" },
                    ...
                    { "3162559", "SAO JOAO DO MANHUAÇU", "MG" },
                    ...
                    { "3201407", "CASTELO", "ES" },
                    { "3201506", "COLATINA", "ES" },
                    { "3201605", "CONCEIÇAO DA BARRA", "ES" },
                    { "3201704", "CONCEIÇAO DO CASTELO", "ES" },
                    { "3201803", "DIVINO DE SAO LOURENÇO", "ES" },
                    ...
                    { "3204807", "SAO JOSE DO CALÇADO", "ES" },
                    ...
                    { "3301405", "CONCEIÇAO DE MACABU", "RJ" },
                    { "3301504", "CORDEIRO", "RJ" },
                    ...
                    { "3546207", "SANTA CRUZ DA CONCEIÇAO", "SP" },
                    ...
                    { "3549953", "SAO LOURENÇO DA SERRA", "SP" },
                    ...
                    { "4107546", "ESPIGAO ALTO DO IGUAÇU", "PR" },
                    { "4107553", "FAROL", "PR" },
                    { "4107603", "FAXINAL", "PR" },
                    ...
                    { "4116505", "NOVA ALIANÇA DO IVAI", "PR" },
                    ...
                    { "4125704", "SAO MIGUEL DO IGUAÇU", "PR" },
                    { "4125753", "SAO PEDRO DO IGUAÇU", "PR" },
                    ...
                    { "4126306", "SENGES", "PR" },
                    { "4126355", "SERRANOPOLIS DO IGUAÇU", "PR" },
                    ...
                    { "4216909", "SAO LOURENÇO DO OESTE", "SC" },
                    ...
                    { "4318804", "SAO LOURENÇO DO SUL", "RS" },
                    ...
                    { "5214879", "NOVA IGUAÇU DE GOIAS", "GO" },
